...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      <span className='font-extrabold'>WeCARE</span> Hospital is committed to providing compassionate, quality healthcare with advanced medical technology and expert professionals. 
    ...
    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
      ...
      <li>
        <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Pharmacy </a>
      </li>
